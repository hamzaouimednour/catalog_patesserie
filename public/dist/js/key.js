                        ...
                        $.each(line, function() {
                            ...
                            switch (this[0]) {
                                case 'shift':
                                    ...
                                    break;
                                case 'space':
                                    btn.addClass('jqbtk-space').html('<span class="fa fa-arrows-alt-h"></span>');
                                    break;
                                case 'del':
                                    btn.addClass('jqbtk-del').html('<span class="fa fa-backspace"></span>');
                                    break;
									case 'enter':
								btn.addClass('jqbtk-del').html('<span class="fa fa-align-center"></span>');
								break;
                                default:
